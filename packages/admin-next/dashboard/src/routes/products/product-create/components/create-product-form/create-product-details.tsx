                        ...
                        return (
                          <Form.Item>
                            ...
                            <Form.Control>
                              <Input
                                placeholder={t(
                                  "products.fields.title.placeholder"
                                )}
                                {...field}
                              />
                            </Form.Control>
                        ...
                        return (
                          <Form.Item>
                            ...
                            <Form.Control>
                              <Input
                                placeholder={t(
                                  "products.fields.subtitle.placeholder"
                                )}
                                {...field}
                              />
                            </Form.Control>
                      ...
                      return (
                        <Form.Item>
                          ...
                          <Form.Control>
                            <HandleInput
                              placeholder={t(
                                "products.fields.handle.placeholder"
                              )}
                              {...field}
                            />
                          </Form.Control>
                    ...
                    return (
                      <Form.Item>
                        ...
                        <Form.Control>
                          <Textarea
                            placeholder={t(
                              "products.fields.description.placeholder"
                            )}
                            {...field}
                          />
                        </Form.Control>
                      ...
                      return (
                        <Form.Item>
                          ...
                          <Form.Control>
                            <Input
                              placeholder={t(
                                "products.fields.material.placeholder"
                              )}
                              {...field}
                            />
                          </Form.Control>
                      ...
                      return (
                        <Form.Item>
                          ...
                          <Form.Control>
                            <Input
                              placeholder={t(
                                "products.fields.width.placeholder"
                              )}
                              {...field}
                              type="number"
                              min={0}
                      ...
                      return (
                        <Form.Item>
                          ...
                          <Form.Control>
                            <Input
                              placeholder={t(
                                "products.fields.length.placeholder"
                              )}
                              {...field}
                              type="number"
                              min={0}
                      ...
                      return (
                        <Form.Item>
                          ...
                          <Form.Control>
                            <Input
                              placeholder={t(
                                "products.fields.height.placeholder"
                              )}
                              {...field}
                              type="number"
                              min={0}
                      ...
                      return (
                        <Form.Item>
                          ...
                          <Form.Control>
                            <Input
                              placeholder={t(
                                "products.fields.weight.placeholder"
                              )}
                              {...field}
                              type="number"
                              min={0}
